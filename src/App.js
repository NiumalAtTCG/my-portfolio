...
const handleScroll = (event, targetId) => {
  ...
  const handleWheelScroll = (e) => {
    ...
    if (
      ...
      (scrollContainer.scrollLeft + scrollContainer.clientWidth >= scrollContainer.scrollWidth && e.deltaY > 0) // End of horizontal scroll
    ) {
    ...
    <div className=" bg-black text-white min-h-screen ">
      ...
      {isOpen && (
        <div className="fixed w-auto inset-0 bg-black flex flex-col md:gap-4 items-center justify-center text-white text-2xl z-40  md:text-6xl font-lexendSemiBold">
          ...
          <a
            href="#about"
            onClick={(e) => {handleScroll(e, "about"); setIsOpen(false); }}
            className="block py-4 hover:bg-gray-600 w-96 rounded-2xl text-center"
          >
            About
          </a>
          <a
            href="#skills"
            onClick={(e) =>{ handleScroll(e, "skills"); setIsOpen(false); }}
            className="block py-4 hover:bg-gray-600 w-96 rounded-2xl text-center   "
          >
            Skills
          </a>
          <a
            href="#myprojects"
            onClick={(e) =>{ handleScroll(e, "myProjects"); setIsOpen(false); }}
            className="block py-4 hover:bg-gray-600 w-96 rounded-2xl text-center "
          >
            My Projects
          </a>
          ...
          <div className="relative w-[320px] sm:w-[400px] md:w-[550px] lg:w-[750px] h-auto mx-auto">
            ...
            <div className="absolute inset-0 flex items-center justify-start ps-16 md:ps-36">
              <h1 className=" sm:text-3xl md:text-5xl font-bold text-[#E0E0E0] ps-3 rounded-lg">
                ...
                >
                  <Typewriter
                    words={["Full Stack Developer", "Undergraduate Student", "UI/UX Designer"]}
...
>
  ...
  <h1 className="text-3xl md:text-6xl font-bold text-center px-16 md:px-40 font-lexendSemiBold">
    I am a skilled software developer. I have a passion for building clean, efficient, and user-friendly applications. I am always looking for new opportunities to learn and grow as a developer.
  </h1>
</div>
  ...
  <div className="flex flex-col gap-6 px-6 md:px-16 py-10 w-full">
    ...
    <div className="w-full rounded-lg border border-white flex flex-col md:flex-row items-center md:justify-between px-6 md:px-16 py-6">
      ...
      <div className="flex flex-wrap gap-4 justify-center">
        <img src={html} alt="HTML" className="w-10 md:w-14 h-auto object-contain" />
        <img src={css} alt="CSS" className="w-10 md:w-14 h-auto object-contain" />
        <img src={js} alt="JavaScript" className="w-10 md:w-14 h-auto object-contain" />
        <img src={java} alt="Java" className="w-10 md:w-14 h-auto object-contain" />
        <img src={c} alt="C" className="w-10 md:w-14 h-auto object-contain" />
        <img src={php} alt="PHP" className="w-10 md:w-14 h-auto object-contain" />
      </div>
    </div>
    ...
    <div className="w-full rounded-lg border border-white flex flex-col md:flex-row items-center md:justify-between px-6 md:px-16 py-6">
      ...
      <div className="flex flex-wrap gap-4 justify-center">
        <img src={react} alt="React" className="w-10 md:w-14 h-auto object-contain" />
        <img src={node} alt="Node.js" className="w-10 md:w-14 h-auto object-contain" />
        <img src={boostrap} alt="Bootstrap" className="w-10 md:w-14 h-auto object-contain" />
        <img src={tailwind} alt="Tailwind CSS" className="w-10 md:w-14 h-auto object-contain" />
      </div>
    </div>
    ...
    <div className="w-full rounded-lg border border-white flex flex-col md:flex-row items-center md:justify-between px-6 md:px-16 py-6">
      ...
      <div className="flex flex-wrap gap-4 justify-center">
        <img src={mysql} alt="MySQL" className="w-10 md:w-14 h-auto object-contain" />
        <img src={mongodb} alt="MongoDB" className="w-10 md:w-14 h-auto object-contain" />
      </div>
    </div>
    ...
    <div className="w-full rounded-lg border border-white flex flex-col md:flex-row items-center md:justify-between px-6 md:px-16 py-6">
      ...
      <div className="flex flex-wrap gap-4 justify-center">
        <img src={figma} alt="Figma" className="w-10 md:w-14 h-auto object-contain" />
        <img src={photoshop} alt="Photoshop" className="w-10 md:w-14 h-auto object-contain" />
      </div>
    </div>
  </div>
</div>

<div id="myProjects" className="w-full min-h-screen flex flex-col justify-center px-4 sm:px-6 md:px-16 py-8">
  {/* Heading */}
...
<div id="contact" className="w-full min-h-screen  flex flex-col items-center py-16 px-8">
  ...
  <p className="text-lg text-gray-300 self-center md:self-start max-w-4xl mb-10 px-6 font-lexendSemiBold ">
    Feel free to reach out for collaborations, project inquiries, or just to say hello! I'm always excited to connect and work on new ideas.
  </p>
